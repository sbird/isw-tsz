...
of the contribution comes from the redshfit range $z = 0-3$ and the halo mass range 
...
$\sigma_\epsilon \simeq 9$, for $z_0 = 0.55$. This is still
a considerable uncertainty, but the signal to noise can be
...
dominated. If we remove all information at redshifts $z < 0.3$,
...
$\sigma_\epsilon \simeq 0.9$, which, if achieved, would

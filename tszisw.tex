...
of magnitude, even if the late-time $yT$
correlation is known precisely.  The detectability is, moreover,
limited by cosmic variance and not from measurement noise.
However, we have also included angular modes with $l \leq 1000$, the 
approximate resolution of the Planck satellite,
which improve detectabilty by a factor of a few.
